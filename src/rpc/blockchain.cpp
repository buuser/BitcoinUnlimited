...
UniValue getblockcoinbase(const UniValue& params, bool fHelp)
{
    ...
    const CTxIn& coinbasetx = block.vtx[0].vin[0];
    
    std::string message;

    message.resize(coinbasetx.scriptSig.size());

    std::copy(coinbasetx.scriptSig.begin(), coinbasetx.scriptSig.end(),
    message.begin());
...
{ //  category              name                      actor (function)         okSafeMode
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    { "blockchain",         "getblockcoinbase",       &getblockcoinbase,       true  },
